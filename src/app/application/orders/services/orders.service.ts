...
export class OrderService {
  ...
  getOrderList(queryStr: string) {
    ...
    return this.http.get<any>(this.baseUrl + 'api/web/orders/get/allOrders' + queryStr);
  }
  ...
  checkAreaServicable(queryStr: string) {
    ...
    return this.http.get<any>(this.baseUrl + 'api/commons/get/checkPincodeServicesStatus' + queryStr);
  };
  ...
  productSearch(queryStr: string) {
    ...
    return this.http.get<any>(this.baseUrl + 'api/admin/inventory/get/searchInInventory' + queryStr);
  }
  ...
  // Method: declaring api to delete order from listing
   removeOrder(queryStr: string) {
    ...
    return this.http.get<any>(this.baseUrl + 'api/web/orders/cancelOrder' + queryStr);
  }
