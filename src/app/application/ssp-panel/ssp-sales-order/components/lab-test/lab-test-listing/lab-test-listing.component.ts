...
selectService: string[];
  ...
  // Method: is used to Navigate user to a desired filter Page
   navigateUser() {
    ...
    const tempLink = '/app/ssp-panel/ssp-sales-order/lab-test?' + tempUrlQuery;
  ...
  viewOrder(data) {
    if (!!data.bookingId && data.bookingId !== '') {
      ...
      this.router.navigate(['/app/ssp-panel/ssp-sales-order/lab-test/view-lab-test'], { queryParams: { bookingId: data.bookingId} });
    } else {
      this.toastrService.showError('Error', 'Something went wrong please try again later');
    }
  }
  editOrder(data) {
    if (!!data.bookingId && data.bookingId !== '') {
      // tslint:disable-next-line: max-line-length
      this.router.navigate(['/app/ssp-panel/ssp-sales-order/lab-test/ace-lab-test'], { queryParams: { bookingId: data.bookingId, type: 'edit'}});
    } else {
      this.toastrService.showError('Error', 'Something went wrong please try again later');
    }
  }
